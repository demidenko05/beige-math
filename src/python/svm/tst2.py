...
j = int(MARGB12m[4]) + 1
err = 0
print ('Wmax w1, w2: ', W[0], W[1])
print ('margin max, bHi, bHj, i, j: ', MARGB12[0], MARGB12[1], MARGB12[2], MARGB12[3], MARGB12[4])
# if b != -5.:
  # err = 1
  # print ("b != -5! b = %s " % b)
if not( i == 4 and j == 5) or not( j == 5 and i == 4):
  err = 1
  print ("i, j != 4, 5! - ", i , j)
...
print ('b= ', b)
print ('classification X(-2,-2) and X(-2, -3): ', negposXm2m2, negposXm2m3)
if not( negposXm2m2 < 0. and negposXm2m3 > 0.):
  err = 1
